        ...
        <div>
          ...
          <div className="container container_hemat">
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-control mb-2">
                <label>
                  Prior failed medications: <br />(
                  <strong>
                    medication and duration of treatment/reason for d/c
                  </strong>
                  ):
                </label>
                <input
                  type="text"
                  className="form-control"
                  name="Prior failed medications (medication and duration of treatment/reason for d/c):"
                  size="30"
                  onChange={handleChange}
                />
              </div>
              ...
              <div className="form-control mb-2">
                <label className="form-label">
                  {" "}
                  Is patient currently on RA therapy?{" "}
                </label>{" "}
                <br />
                <div className="form-check form-check-inline">
                  <input
                    ...
                    name="Is patient currently on RA therapy:"
                    defaultValue="Yes"
                    onChange={handleChange}
                  />
              ...
              <div className="form-control mb-2">
                ...
                <div className="form-check form-check-inline">
                  <input
                    type="radio"
                    className="form-check-input"
                    name="Does patient have latex allergy:"
                    defaultValue="Yes"
                    onChange={handleChange}
                  />
              ...
              <div className="form-control mb-2">
                <label className="form-label">
                  Is Patient at risk for osteoporotic fracture as evident by any
                  of the following?
                </label>
                <div className="form-check">
                  <input
                    type="checkbox"
                    className="form-check-input"
                    name="Is Patient at risk for osteoporotic fracture as evident 1:"
                    defaultValue="History of osteoporotic fracture"
                    onChange={handleChange}
                  />
                ...
                <div className="form-check">
                  <input
                    type="checkbox"
                    className="form-check-input"
                    name="Is Patient at risk for osteoporotic fracture as evident 2:"
                    defaultValue="Patient has tried and failed an oral bisphosphonate"
                    onChange={handleChange}
                  />
                  <label className="form-check-label">
                    Patient has tried and failed an oral bisphosphonate
                  </label>
                </div>
                <div className="form-check">
                  <input
                    type="checkbox"
                    className="form-check-input"
                    name="Is Patient at risk for osteoporotic fracture as evident 3:"
                    defaultValue="Patient has documented contraindication/is intolerant to oral bisphosphonate therapy"
                    onChange={handleChange}
                  />
                  <label className="form-check-label">
                    Patient has documented contraindication/is intolerant to
                    oral bisphosphonate therapy (please submit a copy of DEXA
                    w/prescription)
                  </label>
                </div>
              </div>
