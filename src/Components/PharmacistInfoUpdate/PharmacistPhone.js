...
export default function PharmacistPhone(props) {
  ...
  const handleSubmit = (event) => {
    ...
    setBtn(true);
    pharmacistHelper
      .handlePhoneUpdate(props.data.ID, upDateVal.phone)
      .then((res) => {
        setBtn(false);
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="modal-footer">
                    {btnFlag ? (
                      ...
                      <button
                        className="btn btn-primary index-login-button" style={{ position: "inherit" }}
                        type="submit"
                      >
                        Update
                      </button>
