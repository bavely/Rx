          ...
          <div className="container container_covid">
            <form className="mb-3" onSubmit={handleSubmit}>
              ...
              <div className="form-control mb-2">
                <label className="form-label">Patient Eligibility:</label> <br />
                  <p>
              ...
              {/* Q1 */}
              <div className="form-control mb-2">
                <label className="form-label">Covid-19 Test Positive: </label><br />
              ...
              <div className="form-control mb-2">
                <label className="form-label">INDICATION:</label>
                  <label className="form-label">Treatment of mild to moderate COVID-19 patients (<strong>check all that apply</strong>)</label>{" "}
                  <br />
                  <label className="form-label">
              ...
              <div className="form-control mb-2">
                <label className="form-label">INDICATION (Cont): </label><br />
                <label className="form-label">At high risk for developing severe Covid 19 symptoms or hospitalization or death: </label><br />
              ...
              <div className="form-control mb-2">
                <label className="form-label">Post exposure prophylaxis (<strong>check all that apply</strong>) </label><br />
                  <div className="form-check">
                    <input
                      type="checkbox"
                      className="form-check-input"
