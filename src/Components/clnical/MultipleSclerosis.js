        ...
        <div>
          ...
          <div className="container container_hemat">
            <form onSubmit={handleSubmit}>
              ...
              <h3 className="hemo_h3"> Multiple Sclerosis / Clinical Information </h3>
              {/* Q1 */}
              <div className="form-control mb-2">
                <label className="form-label">Has patient been previously treated for this condition?</label><br/>
                <div className="form-check form-check-inline">
                  <input type="radio" name="Has patient been previously treated for this condition:" className="form-check-input" defaultValue="Yes" onChange={handleChange}/>
              ...
              <div className="form-control mb-2">
                ...
                <div className="form-check form-check-inline">
                  <input type="radio" name="Is patient currently on therapy:" className="form-check-input" defaultValue="No" onChange={handleChange}/>
                  <label className="form-check-label">No</label>
                </div>
              </div>
              {/* Q3 */}
              ...
              <div className="form-control mb-2">
                ...
                <input type="text" className="form-control-sm" name="Other:" size="5" onChange={handleChange}/>
              </div>
