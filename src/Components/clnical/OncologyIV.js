        ...
        <div>
          ...
          <div className="container container_hemat">
            <form onSubmit={handleSubmit}>
              {/* 3. Oncology / Clinical Information */}
              <h3 className="hemo_h3"> Oncology / Clinical Information </h3>
              {/* Q1 */}
              <div className="form-control mb-2">
                ...
                <div className="form-check form-check-inline">
                  <input type="radio" className="form-check-label" name="Has patient been previously treated for this condition:" defaultValue="No" onChange={handleChange}/>
              ...
              {/* Q2 */}
              <div className="form-control mb-2">
                <label className="form-label"> Is patient currently on therapy? </label>
                <div className="form-check form-check-inline">
              ...
              <div className="form-control mb-2">
                ...
                <input type="text" name="Diagnosis (ICD-10):" className="form-control-sm" size="10" onChange={handleChange}/>
                </div>
