        ...
        <div>
          ...
          <div className="container container_hemat">
            <form onSubmit={handleSubmit}>
              ...
              <h3 className="hemo_h3"> Rheumatology / Clinical Information </h3>
              {/* Q1 */}
              <div className="form-control mb-2">
                <label className="form-label">Diagnosis:</label>
                <input type="text" className="form-control" name="Diagnosis:" size="60" onChange={handleChange}/>
                <label className="form-label">Other: </label>
                <input type="text" name="Other:" size="60" className="form-control" onChange={handleChange}></input>
              </div>
              {/* Q2 */}
              <div className="form-control mb-2">
                <label className="form-label">Prior failed medications <br/>
                  (<strong>medication and duration of treatment/reason for d/c</strong>):</label>
                <input type="text" className="form-control" name="Prior failed medications (medication and duration of treatment/reason for d/c):" size="60" onChange={handleChange}/>
              </div>
              <div className="form-control mb-2">
                <label className="form-label mt-2"> Is patient currently on RA therapy? </label> <br/>
                ...
                <input className="form-control" type="text" name="Medications:" size="60" onChange={handleChange}/>
                ...
                <div className="form-check form-check-inline">
                  <input type="radio" className="form-check-input" name="TB/PPD test given:" defaultValue="No"/>
              ...
              <div className="form-control mb-2">
                ...
                <input type="text" className="form-control-sm" name="BMD/T-score:" size="10" onChange={handleChange}/> &nbsp;
              ...
              <div className="form-control mb-2">
                ...
                <div className="form-check form-check-inline">
                  ...
                  <div className="form-check form-check-inline">
                    <input type="radio" className="form-check-input" name="Does patient have latex allergy:" defaultValue="No" onChange={handleChange}/>
                    <label className="form-check-label">No</label>
                </div>
              </div>
              {/* Q8 */}
              <div className="form-control mb-2">
                ...
                <div className="form-check">
                  ...
                  <input type="text" className="form-control-sm" name="Site:" size="10" onChange={handleChange}/> &nbsp;
                  <label className="form-label">Date:</label> &nbsp;
                  <input type="date" name="Date:" className="form-control-sm" onChange={handleChange}/>
                </div>
                <div className="form-check">
                  <input type="checkbox" className="form-check-input" name="Is Patient at risk for osteoporotic fracture as evident 2:" onChange={handleChange}/>
                  <label className="form-check-label">Patient has tried and failed an oral bisphosphonate</label>
                </div>
                <div className="form-check">
                  <input type="checkbox" className="form-check-input" defaultValue="Patient has documented contraindication/is intolerant to oral bisphosphonate therapy" onChange={handleChange}/>
                  <label>Patient has documented contraindication/is intolerant to oral
                    <br />
                    bisphosphonate therapy (please submit a copy of DEXA w/prescription)
                  </label>
                </div>
              </div>
