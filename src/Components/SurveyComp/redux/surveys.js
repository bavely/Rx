...
export const get = createAsyncThunk('surveys/get', async (id) => {
...
export const remove = createAsyncThunk('surveys/delete', async (id) => {
    const response = await axios.get(apiBaseAddress + '/delete?id=' + id)
    return response.data
})
// {id: string, json: any, text: string}
export const update = createAsyncThunk('surveys/update', async (data) => {
