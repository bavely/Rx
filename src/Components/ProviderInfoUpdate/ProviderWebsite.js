...
export default function ProviderWebsite(props) {
    const divStyle = {
        color: "black",
      ...
      const handleSubmit = (event) => {
        ...
        setBtn(true);
        providerHelper.handleWebsiteUpdate(props.data.ID, upDateVal.website).then((res) => {
          setBtn(false);
          if (res.status === 200 ) {
            console.log(res);
            
            setData({
                website: upDateVal.website,
            });
                ...
                <div className="modal-dialog">
                  <div className="modal-content">
                    <div className="modal-header" style={{ backgroundColor: "steelblue" }}>
                      <h5 className="modal-title text-light"> Update website </h5>
                      <button
                        type="button"
                        className="btn-close"
